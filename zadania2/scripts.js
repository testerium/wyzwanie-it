...
sklepy.forEach(sklep => {
  sklep.produkty.forEach(produkt => {
...
aldi.produkty.forEach(produkt => {
  if(!nazwyProduktow.includes(produkt.nazwa)) {
    console.log(produkt.nazwa)
    nazwyProduktow.push(produkt.nazwa)
  }
})
